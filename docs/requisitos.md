...
**Criterios de aceptación:**
- La bomba se activa cuando la humedad del suelo baja del 30%.
- La bomba se apaga cuando la humedad del suelo supera el 45%.
- El sistema implementa histéresis para evitar encendidos y apagados frecuentes.
...
| RF-04 | El sistema debe activar la bomba cuando humedad suelo < 30% | control_manager |
| RF-05 | El sistema debe desactivar la bomba cuando humedad suelo > 45% | control_manager |
